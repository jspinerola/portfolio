    ...
    >
      {[...selectedValues]
        ...
        .map((value) => (
          ...
          >
            <Tag title={items.get(value)?.toString() || value} key={value}>
              {clickToRemove && (
